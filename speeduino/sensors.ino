...
void readTPS()
{
  ...
  #endif
  tempTPS = 255 - tempTPS; //TPS reversed. Els valors de TPS surtien invertits sense aquesta sentència
...
void readIPS()//Idle Potentiometer Sensor
{
    ...
    currentStatus.IPS = map(currentStatus.ipsADC, ipsMin, ipsMax, 0, 100); //Take the raw TPS ADC value and convert it into a TPS% based on the calibrated values
}
