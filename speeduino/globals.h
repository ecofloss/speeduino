...
#define IPS_TARGET   92 //This is the IPS ADC value with which the engine idle at 850 rpm
...
struct config3 {
  ...
  byte iacAlgorithm : 3; //Valid values are: "None", "On/Off", "PWM", "PWM Closed Loop", "Stepper", "Stepper Closed Loop", "PWM with IPS/CTPS"
